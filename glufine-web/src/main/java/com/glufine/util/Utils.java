...
//
//        System.out.println(Utils.toHexString("01 30 30 31 30 30 30 31 5D C6"));
//        System.out.println(Utils.toHexString("01303031303030315DC6"));
//        System.out.println(Utils.toHexString("03 30 30 30 31 30 30 30 30 30 31 33 37 30 76 DE"));
...
//        System.out.println(Utils.toHexString(Constants.SPLIT_START+Constants.COMMOND_BOX_FIRST_BACK+"12.23-P00000016013104071701701700CEMU212-M1038007103888831?1:;@"));
        System.out.println(Utils.toHexString(Constants.SPLIT_START+Constants.COMMOND_BOX_FIRST_BACK+"0400000000000000000000000000000000000000000000000111038888312<85@"));
    }
